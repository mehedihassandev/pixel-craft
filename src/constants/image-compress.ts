...
export const compressionFeatures = [
    {
        ...
        description: "Advanced compression algorithms with Web Worker support for blazing fast processing",
    },
    {
        icon: Shield,
        title: "Quality Preserved",
        description: "Maintain visual quality while reducing file size by up to 80% with smart optimization",
    },
    {
        icon: Gauge,
    ...
    },
    {
        ...
        description: "Fine-tune compression parameters including quality, size limits, and output format",
    },
    {
        icon: Archive,
