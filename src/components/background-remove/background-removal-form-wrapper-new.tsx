        ...
        <div className="space-y-6">
          ...
          <Alert className="border-green-200 bg-green-50 dark:bg-green-900/20">
            ...
            <AlertDescription className="text-green-800 dark:text-green-200">
              Background removed successfully! You can now download your image with transparent
              background.
            </AlertDescription>
          </Alert>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-center">
                <div>
                  ...
                  <p className="font-semibold">
                    {processedImage.originalFile.type.split('/')[1].toUpperCase()}
                  </p>
                </div>
                <div>
                ...
                <div>
                  ...
                  <p className="font-semibold">
                    {(processedImage.originalFile.size / 1024 / 1024).toFixed(2)} MB
                  </p>
                </div>
                <div>
