...
import { Wand2, Loader2, Palette, Grid3X3, Type, FileImage } from 'lucide-react';
...
export const PlaceholderForm = ({ options, setOptions }: PlaceholdrFormProps) => {
  ...
  useEffect(() => {
    ...
    const validHeight = height && !isNaN(height) && height > 0 ? height : 400;
    ...
    setOptions((prev: PlaceholdrOptions) => ({
      ...
      format: format || 'png',
      fontSize: fontSize && !isNaN(fontSize) && fontSize > 0 ? fontSize : null,
    }));
    ...
    <div className="space-y-6">
      ...
      <Card className="border-0 bg-white/70 dark:bg-gray-900/70 backdrop-blur-sm shadow-lg">
        <CardHeader>
          ...
          <CardDescription>Set the width and height of your placeholder image</CardDescription>
        </CardHeader>
      ...
      <Card className="border-0 bg-white/70 dark:bg-gray-900/70 backdrop-blur-sm shadow-lg">
        <CardHeader>
          ...
          <CardDescription>Customize background and text colors using hex codes</CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <div className="grid grid-cols-2 gap-4">
            <div className="space-y-2">
              ...
              <div className="flex gap-2">
                <RhfTextField
                  ...
                  maxLength={6}
                  className="font-mono"
                  onCustomChange={event => handleColorChange('bgColor', event.target.value)}
                />
                <div
            ...
            <div className="space-y-2">
              ...
              <div className="flex gap-2">
                <RhfTextField
                  ...
                  maxLength={6}
                  className="font-mono"
                  onCustomChange={event => handleColorChange('textColor', event.target.value)}
                />
                <div
                  className="w-10 h-10 rounded border border-border shrink-0"
      ...
      <Card className="border-0 bg-white/70 dark:bg-gray-900/70 backdrop-blur-sm shadow-lg">
        <CardHeader>
          ...
          <CardDescription>Add custom text and control font sizing</CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <RhfTextField
            control={control}
          ...
          <div className="space-y-2">
            ...
            {text && !fontSize && (
              <p className="text-xs text-muted-foreground">
                Leave empty for auto-calculated font size based on dimensions
              </p>
            )}
          </div>
        </CardContent>
      ...
      <Card className="border-0 bg-white/70 dark:bg-gray-900/70 backdrop-blur-sm shadow-lg">
        <CardHeader>
          ...
          <CardDescription>Choose the output format for your placeholder image</CardDescription>
        </CardHeader>
        <CardContent>
          <RhfSelect
            control={control}
          ...
          <div className="mt-4 p-3 bg-muted rounded-lg">
            <div className="text-sm space-y-1">
              ...
              <div className="grid grid-cols-1 gap-1 text-muted-foreground">
                <div>
                  • <span className="font-medium">PNG:</span> Best quality, supports transparency
                </div>
                <div>
                  • <span className="font-medium">JPG:</span> Smaller file size, good for photos
                </div>
                <div>
                  • <span className="font-medium">WebP:</span> Modern format, excellent compression
                </div>
              </div>
            </div>
          </div>
