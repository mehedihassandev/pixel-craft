    ...
    <div className="container mx-auto px-4 py-8 space-y-12 max-w-7xl relative">
      ...
      <div className="text-center space-y-4 relative">
        ...
        <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
          Reduce your image file sizes without compromising quality. Advanced compression algorithms
          with support for multiple formats, batch processing, and real-time preview.
        </p>
        ...
        <div className="relative space-y-12">
          ...
          <div className="space-y-6">
            <div className="text-center">
              <h2 className="text-3xl font-bold mb-2">Compress Your Images</h2>
